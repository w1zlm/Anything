(() => {
    ...
    window.document.addEventListener("fapiloaded", function() {
        ...
        diagonalSplit1.icon_url = window.game.FAPI.img_sources.arrow1;
        ...
        diagonalSplit2.icon_url = window.game.FAPI.img_sources.arrow2;
        ...
        diagonalSplit3.icon_url = window.game.FAPI.img_sources.arrow3;
        ...
        diagonalSplit4.icon_url = window.game.FAPI.img_sources.arrow4;
        ...
        blueBlocker.icon_url = window.game.FAPI.img_sources.arrow5;
        ...
        blueBlocker.name = ["Blue blocker", "Синий блокер", ".", "."];
        blueBlocker.info = ["On any incoming signal.", "Любым входящим сигналом.", ".", "."];
        blueBlocker.does = ["Turns off the arrow after 1 cell in front of it.", "Выключает стрелку через 1 клетку перед собой.", ".", "."];
        blueBlocker.icon_url = window.game.FAPI.img_sources.arrow5;
        blueBlocker.is_pressable = false;
        ...
        doubleAnd.icon_url = window.game.FAPI.img_sources.arrow6;
        ...
        tFlipFlopSplit1.icon_url = window.game.FAPI.img_sources.arrow7;
        ...
        tFlipFlopSplit2.icon_url = window.game.FAPI.img_sources.arrow8;
